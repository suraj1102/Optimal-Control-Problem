...
from problems.cart_pole import cart_pole
...
if __name__ == "__main__":
    Hyperparams_obj = Hyperparams.from_yaml("yamls/cart_pole.yaml")
    ...
    problem = cart_pole(Hyperparams_obj)
    ...
    simulator.test_model(
        ...
        patience=50,
        random=True,
        ranges = [[-np.pi, np.pi], [-np.pi, np.pi], [5.0, 5.0], [-5.0, 5.0]],
        plot=True
    )
